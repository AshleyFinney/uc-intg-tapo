...
- **Touch slider needs explicit Brightness selection.** When you bind a light to an activity's touch slider, the Feature dropdown shows "Brightness" pre-selected. The binding doesn't actually save correctly until you open the dropdown and pick Brightness yourself, then save. If the slider feels dead after you bind it, this is almost always why.
